...
jogos numa variavel dados. Essa variavel contem todas as informacoes do arquivo
...
def nome_campeao(dados):
    temp = dados['fases']['2700']['classificacao']['grupo']['Único'][0]
    return dados['equipes'][temp]['nome-comum']
...
def ids_dos_times_de_um_jogo(dados,id_jogo):
    time1 = 12
    time2 = 13
    return time1,time2 #assim a gente retorna as duas respostas
'''
...
def datas_de_jogo(dados):
    datas = []
    for a in dados['fases']['2700']['jogos']['data']:
        datas.append(a)
    return datas
...
def busca_imprecisa_por_nome_de_time(dados, nome_time):
    ...
    for a in dados['equipes']:
        if nome_time in dados['equipes'][a]['nome']:
            lista.append(dados['equipes'][a]['id'])
        elif nome_time in dados['equipes'][a]['nome-comum']:
            lista.append(dados['equipes'][a]['id'])
        elif nome_time in dados['equipes'][a]['nome-slug']:
            lista.append(dados['equipes'][a]['id'])
        elif nome_time in dados['equipes'][a]['sigla']:
            lista.append(dados['equipes'][a]['id'])
    return lista
...
def ids_de_jogos_de_um_time(dados, time_id):
    ...
    for a in dados['fases']['2700']['jogos']['id']:
        if time_id in dados['fases']['2700']['jogos']['id'][a]['time1']:
            id_jogos.append(a)
        elif time_id in dados['fases']['2700']['jogos']['id'][a]['time2']:
            id_jogos.append(a)
    return id_jogos
...
def rebaixados(dados):
    rebaixados = []
    rebaixamentoInicio = int(dados['fases']['2700']['faixas-classificacao']['classifica3']['faixa'].split('-')[0])-1
    rebaixamentoFinal = int(dados['fases']['2700']['faixas-classificacao']['classifica3']['faixa'].split('-')[1])
    for a in dados['fases']['2700']['classificacao']['grupo']['Único'][rebaixamentoInicio:rebaixamentoFinal]:
        rebaixados.append(a)
    return rebaixados
